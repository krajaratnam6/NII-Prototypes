...
class LeveledAgentWithFeedback():
    def __init__(self, min_lv_ratio, max_iter, user_cefr_level, verbosity):
        ...
        task += "You are 30 years old, college educated, and speak English natively and quite articulately.\n"
        ...
        task += "You are currently sitting alone at a cafe with your laptop out.\n"
